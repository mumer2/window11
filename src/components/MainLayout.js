...
const MainLayout = () => {
  ...
  const [selectedContent, setSelectedContent] = useState("This PC");
  ...
  const renderContent = () => {
    switch (selectedContent) {
      ...
      case "Gallery":
        return (
          <div className="mt-6 p-5 text-center justify-center text-gray-400">
          ...
          <div className="flex m-2">
            <div className="flex flex-col items-center text-black w-24 h-full cursor-pointer hover:bg-slate-200 mt-5 p-2 ">
              <Image
                ...
                alt={"MongoDB"}
                className="w-12 h-12 bg-white rounded p-2"
              />
              <span className="text-xs text-center mt-2">MongoDB Compass</span>
            </div>
            <div className="flex flex-col items-center text-black w-24 h-full cursor-pointer hover:bg-slate-200 mt-5 p-2 ">
              <Image
                width={60}
    ...
    <div className="h-screen flex mt-20">
      ...
      <div className="w-1/6 h-[calc(80vh-5rem)] mt-3 overflow-y-auto">
        <ul className="space-y-2 mt-2">
          <li
            className={`flex items-center text-xs pl-10 pr-10 space-x-2 cursor-pointer hover:bg-slate-200 p-2 rounded"
              ${
                selectedContent === "Home"
                  ? "bg-slate-300 border border-black"
                  : ""
              }`}
          ...
          <li
            className={`flex items-center text-xs pl-10 pr-10 space-x-1 cursor-pointer hover:bg-slate-200 p-2 rounded"
              ${
            ...
            <span>
              ...
              >
                <path
                  ...
                  d="M39.236 42.5H8.764M24 33.924V5.5M12.287 22.211L24 33.924l11.713-11.713"
                />
              </svg>{" "}
            </span>
            <span>Downloads</span>
          ...
          >
            <span>
              ...
              >
                <path
                  fill="#c15777"
                  d="M16 9V7h-4v5.5c-.42-.31-.93-.5-1.5-.5A2.5 2.5 0 0 0 8 14.5a2.5 2.5 0 0 0 2.5 2.5a2.5 2.5 0 0 0 2.5-2.5V9zm-4-7a10 10 0 0 1 10 10a10 10 0 0 1-10 10A10 10 0 0 1 2 12A10 10 0 0 1 12 2"
                />
              </svg>
            </span>
            <span>Music</span>
          ...
          <li
            className={`flex flex-col text-xs cursor-pointer p-2 hover:bg-slate-200
          ${
            selectedContent === "This PC"
              ? "bg-slate-300 border border-black"
              : ""
          }`}
              ...
              >
                <svg
                  className={`transform transition-transform ${
                    showDrives ? "rotate-180" : "rotate-0"
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="1em"
                  height="1em"
                ...
                <span className="ml-1">This PC</span>
              </div>

              {showDrives && (
                <div className="ml-2 mt-2 space-y-2 w-full">
          ...
          <li
            className={`flex items-center text-xs pl-11 pr-10 space-x-2 cursor-pointer hover:bg-slate-200 p-2 rounded"
              ${
          ...
          >
            <span className=" relative">
              <Image
                ...
                alt="windows icon"
              />
              <Image src={"/images/d1.png"} width={16} height={16} alt="disk" />
            </span>
            <span>Network</span>
          </li>
        </ul>
      ...
      <div className="w-full mt-2 bg-white overflow-y-auto">
        {renderContent()}
      </div>
    </div>
  );
