        ...
        <div className="flex items-center space-x-5 ">
          ...
          <span className="opacity-30 ">
            ...
            >
              <path
                fill="black"
                d="M5.92 2.228a.5.5 0 0 0-.84.544L9.405 9.43L7.48 12.39a3 3 0 1 0 .779.636L10 10.348l1.74 2.68a3 3 0 1 0 .779-.636zM14 17a2 2 0 1 1 0-4a2 2 0 0 1 0 4M4 15a2 2 0 1 1 4 0a2 2 0 0 1-4 0m7.192-6.489l-.596-.918l3.485-5.365a.5.5 0 0 1 .838.544z"
              />
            </svg>
          </span>
          ...
          <span className="opacity-30 ">
            ...
            >
              ...
              >
                ...
                <path d="M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v0a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2m0 9h.01M9 17h.01M12 16l1 1l3-3" />
              </g>
            </svg>
          </span>
          ...
          <span className="opacity-30 ">
            ...
            >
              <path
                fill="black"
                d="M2048 388v1524H268v-384h116v268h1548V504h-780V388zM374 1272H0v-44q19-3 38-5t37-8q14-4 30-26t32-49t27-53t19-41l388-918h82l382 928q9 22 21 50t29 53t38 44t49 22t56 3v44H782v-44h37q20 0 37-3t30-16t12-37q0-22-11-60t-26-80t-30-79t-26-62H359q-9 23-26 61t-34 80t-29 79t-13 60q0 24 12 35t30 16t38 4t37 2zm28-509h344L570 385z"
              />
            </svg>
          </span>
          ...
          >
            <span>
              ...
              >
                ...
                >
                  <path
                    stroke="#344054"
                    d="M16.667 41.667V8.333m6.25 6.25l-6.25-6.25l-6.25 6.25"
                  />
                  <path
                    stroke="#306cfe"
                    d="m27.083 35.417l6.25 6.25l6.25-6.25m-6.25-27.084v33.334"
                  />
                </g>
              </svg>
            </span>
            ...
            {isSortDropdownOpen && (
              <div className="absolute left-0 mt-10 text-sm w-32 bg-white border rounded-md shadow-lg z-10">
                <ul>
                  <li className="list-disc ml-6 px-4 py-2 hover:bg-slate-200 cursor-pointer">
                    Name
                  </li>
                  <li className="px-4 py-2 ml-6 hover:bg-slate-200 cursor-pointer">
                    Date
                  </li>
                  <li className="px-4 py-2 ml-6 hover:bg-slate-200 cursor-pointer">
                    Type
                  ...
                  <li className="list-disc px-4 py-2 ml-6 hover:bg-slate-200 cursor-pointer">
                    Ascending
                  </li>
                  <li className="px-4 py-2 ml-6 hover:bg-slate-200 cursor-pointer">
                    Descending
          ...
          >
            <span>
              ...
              >
                <path
                  fill="black"
                  d="M0 1152h640v640H0zm128 512h384v-384H128zM0 256h640v640H0zm128 512h384V384H128zm1920-384v128H896V384zm-384 384H896V640h768zm-768 512h1152v128H896zm0 256h768v128H896z"
                />
              </svg>
            </span>
            <span className="cursor-pointer">
                  ...
                  <li className="flex gap-2 px-4 py-2 hover:bg-slate-200 cursor-pointer">
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth="2"
                        d="M5 7h14m4 0h4M5 13h10m8 0h4M5 19h14m4 0h4M5 25h12m6 0h4"
                      />
                    </svg>
                    List
                  </li>
          ...
          <span>
            ...
            >
              <path
                fill="black"
                d="M3.5 11a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3M8 11a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3m4.5 0a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3m6-1.5a1.5 1.5 0 1 1-3 0a1.5 1.5 0 0 1 3 0"
              />
            </svg>
          </span>
        </div>
          ...
          <span>
            <p className="flex flex-inline mr-4 gap-2 text-sm text-gray-450">
              <svg
                ...
                viewBox="0 0 32 32"
              >
                <path fill="black" d="M19 10h7v2h-7zm0 5h7v2h-7zm0 5h7v2h-7z" />
                <path
                  fill="black"
                  d="M28 5H4a2 2 0 0 0-2 2v18a2 2 0 0 0 2 2h24a2.003 2.003 0 0 0 2-2V7a2 2 0 0 0-2-2M4 7h11v18H4Zm13 18V7h11l.002 18Z"
                />
