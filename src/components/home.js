...
const Home = () => {
  ...
  return (
    <div>
         <div
        className="flex cursor-pointer pl-10 h-8"
        onClick={handleClick}
      >
        <svg
          className={`transform transition-transform ${showIcons ? 'rotate-180' : 'rotate-0'}`}
...
<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 pl-20 pr-20">
  <div className="p-4 gap-3 flex flex-row items-center cursor-pointer hover:bg-gray-100">
    <img src="/images/desktop.png" alt="Folder" className="h-12 w-12" />
    <div className='flex flex-col'>
    <span className="font-medium text-md">Desktop</span>
    <span className="font-medium text-xs text-gray-500">Stored Localy</span>
    </div>
  </div>
  <div className="p-4 gap-3 flex flex-row items-center cursor-pointer hover:bg-gray-100">
    <img src="/images/download2.png" alt="Folder" className="h-12 w-12" />
    <div className='flex flex-col'>
  ...
  <div className="p-4 gap-3 flex flex-row items-center cursor-pointer hover:bg-gray-100">
    <img src="/images/document2.png" alt="Folder" className="h-12 w-12" />
    <div className='flex flex-col'>
  ...
  <div className="p-4 gap-3 flex flex-row items-center cursor-pointer hover:bg-gray-100">
    <img src="/images/picture2.png" alt="Folder" className="h-12 w-12" />
    <div className='flex flex-col'>
  ...
  <div className="p-4 gap-3 flex flex-row items-center cursor-pointer hover:bg-gray-100">
    <img src="/images/music2.png" alt="Folder" className="h-12 w-12" />
    <div className='flex flex-col'>
  ...
  <div className="p-4 gap-3 flex flex-row items-center cursor-pointer hover:bg-gray-100">
    <img src="/images/video2.png" alt="Folder" className="h-12 w-12" />
    <div className='flex flex-col'>
