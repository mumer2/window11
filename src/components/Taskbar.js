...
const Taskbar = () => {
  ...
  const [isIconDropupOpen, setIsIconDropupOpen] = useState(false);
  ...
  const toggleIconDropup = () => {
    setIsIconDropupOpen(!isIconDropupOpen);
  };
  ...
  return (
    ...
    <div className="flex space-x-3 items-center justify-start">
      ...
      <div className="flex space-x-3 items-center justify-end">
        <span className="text-xs items-center hover:bg-white cursor-pointer"
          onClick={toggleIconDropup}
        >
          <svg
           className={`transform transition-transform ${
            isIconDropupOpen ? "rotate-180" : "rotate-0"
          }`}
            xmlns="http://www.w3.org/2000/svg"
            width="3em"
            height="3em"
