...
const Taskbar = () => {
  ...
  return (
    <div className="fixed bottom-0 w-full h-12 bg-slate-200 z-50 flex justify-between items-center px-2 shadow-md">
          ...
          <div className="absolute bottom-12 bg-slate-200 border space-x-5 w-[600] h-[540] bg-white text-black center justify-center rounded-lg p-3 shadow-lg">
            ...
            <div>
              ...
              <div className="mt-20 pt-20 border-b-2">
                <h2 className="text-md font-medium">Recommended</h2>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="none" stroke="black" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5V3m0 18v-2M7.05 7.05L5.636 5.636m12.728 12.728L16.95 16.95M5 12H3m18 0h-2M7.05 16.95l-1.414 1.414M18.364 5.636L16.95 7.05M16 12a4 4 0 1 1-8 0a4 4 0 0 1 8 0"/></svg>
      </div>
    ...
    <div className=" flex mt-5 justify-between">
      ...
      <span>
        ...
        <span className="text-xs mr-4" onClick={toggleWidgetDropup}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="1.6em"
            height="2em"
